...
class FiPyProfileTime(FiPyProfile):
    def __init__(self, runfunc, ncells, funcString, regenerate=False):
    ...
    def plot(self, keys, field="cumulative", doFullProfile = True, shortLabel = True):
        ...
        #plt.show() 
        plt.savefig("polyxtal_speed.png")

def plotIP(self, keys, field="cumulative", doFullProfile = True, shortLabel = True):
        ...
        #plt.show() 
        plt.savefig("polyxtal_speed_gmsh.png")
